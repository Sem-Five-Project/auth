...
public class PaymentController {
    ...
    public ResponseEntity<PaymentCompleteResponse> confirmPayment(@Valid @RequestBody PaymentCompleteDTO dto) {
        try {
            ...
            String message = success ? "Payment completed and class booked successfully."
                    : "Payment refunded as some slots were not locked.";
    ...
    public ResponseEntity<String> handlePayHereNotify(@RequestParam Map<String, String> payload) {
        try {
            ...
            // Respond 200 OK so PayHere stops retrying, but log the problem for
            // investigation.
